...
public class AuctionUser
    ...
    private static final long serialVersionUID = -7426586071259512868L;
    ...
    @Pattern(regexp = "((?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%]).*)", message = "Invalid password - please enter at "
            + "least: one digit; one lowercase; one uppercase; one symbol \"@#$%\"")
    ...
    public AuctionUser(String displayName, String password, String email,
            String street, String cityState, String zip) {
