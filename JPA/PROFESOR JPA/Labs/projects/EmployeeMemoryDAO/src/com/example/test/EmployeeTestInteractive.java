...
public class EmployeeTestInteractive
{
    ...
    public static Employee inputEmployee( BufferedReader in ) throws
        ParseException, IOException
    {
        return inputEmployee( in, null, true );
    }

    public static Employee inputEmployee( BufferedReader in,
        Employee empDefaults ) throws ParseException, IOException
    {
        return inputEmployee( in, empDefaults, false );
    }

    public static Employee inputEmployee( BufferedReader in,
        Employee empDefaults, boolean newEmployee ) throws ParseException,
        IOException
    {
