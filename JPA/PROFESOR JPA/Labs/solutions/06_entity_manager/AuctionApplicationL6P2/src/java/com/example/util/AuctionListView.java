...
public class AuctionListView
{
    ...
    public AuctionListView( int auctionId, int imageId, String title,
        String description, String condition, int numBids, int numWatches,
        float currPrice, float bidPrice, String timeRemaining )
    {
