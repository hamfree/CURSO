...
//    @NamedQuery(name = "Auction.findbyStatusJoinFetch", query = "SELECT a FROM Auction a JOIN FETCH a.bids LEFT JOIN FETCH a.watchers WHERE a.status = :status ORDER BY a.endDate ASC, a.currPrice ASC")
})
