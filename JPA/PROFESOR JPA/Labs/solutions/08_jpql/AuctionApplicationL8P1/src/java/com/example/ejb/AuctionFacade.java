...
public class AuctionFacade
{
    ...
    public AuctionListView[] getSearchListView( String searchStr )
    {
        ...
        Auction[] auctionList;
        TypedQuery<Auction> searchQuery = em.createQuery(
            "SELECT a FROM Auction a WHERE UPPER(a.item.title) LIKE :search", Auction.class );
    ...
    private AuctionUser getUserByName( String userName )
    {
        ...
        if ( userName != null ) {
            final String query = "SELECT au FROM AuctionUser au WHERE au.displayName = :displayName";
            TypedQuery<AuctionUser> findAuctionUser = em.createQuery( query, AuctionUser.class );
    ...
    public AuctionListView[] getAllAuctionListView()
    {
        Auction[] auctionList = null;
        try {
            TypedQuery<Auction> query = em.createQuery(
                "SELECT a FROM Auction a ORDER BY a.endDate ASC, a.currPrice ASC", Auction.class );
        ...
        ItemCondition condition )
    {
        ...
        try {
            ...
            TypedQuery<Auction> query = em.createQuery(
                auctionQuery.toString(), Auction.class );
    ...
    public AuctionListView[] getAllAuctionListView(
        String userName, AuctionStatus status, ItemCondition condition )
    {
        Auction[] auctionList = null;
        try {
            ...
            StringBuilder auctionQuery = new StringBuilder();
            auctionQuery.append(
                "SELECT a FROM Auction a WHERE a.seller = :seller AND a.status = :status " );
            if ( condition != null ) {
                auctionQuery.append( "AND a.item.condition = :condition " );
            }
            auctionQuery.append( "ORDER BY a.endDate ASC, a.currPrice ASC" );

            TypedQuery<Auction> query = em.createQuery( auctionQuery.toString(), Auction.class );
