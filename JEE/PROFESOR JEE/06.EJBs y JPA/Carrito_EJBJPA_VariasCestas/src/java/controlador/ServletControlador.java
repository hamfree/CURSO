 ...
 * @author jesus
 */
@WebServlet(name = "ServletControlador", urlPatterns = {"/comprar", "/finalizar", "/confirmar"})
public class ServletControlador extends HttpServlet {
    private static final long serialVersionUID = 1091035626483108193L;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion.equals("/comprar")) {
            ...
            // en las JSP se podria manejar el Servicio pero
