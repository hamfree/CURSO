 ...
 * @author curso
 */
@WebServlet(name = "AgregarPersonaServlet", urlPatterns = {"/agregarPersona"})
public class AgregarPersonaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AgregarPersonaServlet</title>");            
            out.println("<meta charset='UTF-8'>");
            out.println("<meta name='viewport' content='width=device-width, initial-scale=1.0'>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Persona agregada : DNI = '" + d + "',Nombre = '" + n + "', Apellido = '" + a + "'</h1>");
            out.println("<p><a href='index.html'>Volver al inicio</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
