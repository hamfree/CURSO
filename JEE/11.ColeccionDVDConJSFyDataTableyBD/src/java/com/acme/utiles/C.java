...
/**
 * Constantes usadas en la aplicación. Contiene los datos de acceso JDBC a la
 * BBDD world de MySQL así como los nombres de las tablas, campos y otras
 * constantes que se repiten a lo largo de la aplicación
 *
 * @author hamfree
 */
public class C {
    /**
     * Indica si se muestran por la consola mensajes de traza o no. Si vale
     * true se mostrarán mensajes de traza en la consola. Si vale false no se 
     * mostrarán mensajes de traza por la consola
     */
    ...
    /**
     * Para mostrar mensajes de depuración por la consola. Depende de la
     * constante DBG. Si vale true se mostrará el mensaje y no hará nada
     * en caso contrario.
     * 
