...
public class DVDController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Debug
        this.log("Acción recibida :" + accion);
        this.log("Coleccion :" + listaDvd.toString());
        this.log("Usuario (request):" + request.getParameter("usuario"));
        this.log("Clave (request):" + request.getParameter("clave"));
        this.log("Usuario (sesion):" + ses.getAttribute("usuario"));
        this.log("Clave (sesion):" + ses.getAttribute("clave"));
        //Fin debug

        switch (accion) {
            case "login":
                ses.setAttribute("usuario", request.getParameter("usuario"));
                ses.setAttribute("clave", request.getParameter("clave"));
